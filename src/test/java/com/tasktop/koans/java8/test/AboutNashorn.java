...
public class AboutNashorn {
	...
	public void evaluateScript() throws ScriptException {
		...
		Object result = engine.eval("2"); // FIXED: pass in a script that produces 2
	...
	public void registerAndExecuteFunction() throws ScriptException, NoSuchMethodException {
		...
		engine.eval("function sayHello() { return 'Hello' };"); // FIXED: changed the registered function to return hello.
